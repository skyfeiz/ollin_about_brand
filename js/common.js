...
(function(){
 ...
 +'       </li>'
 +'       <li class="last_li">'
 +'       <span class="sec_title"><i class="comin_icon icon"></i>关于品牌</span>'
 +'       <div class="thi_title">'
 +'       <a class="target_title" href="about_brand.html">品牌介绍</a>'
 +'       <a class="target_title" href="about_honor.html">品牌荣誉</a>'
 +'       <a class="target_title" href="about_history.html">品牌历程</a>'
 +'       <a class="target_title" href="about_technology.html">技术研发</a>'
 +'       <a class="target_title" href="about_investment.html">招商加盟</a>'
 +'       <a class="target_title" href="about_contack.html">联系我们</a>'
 +'       </div>'
 +'       </li>'
 +'       </ul>'
 +'       </div>'
 ...
 +'       <option selected value ="">福田汽车家族网站</option>'
